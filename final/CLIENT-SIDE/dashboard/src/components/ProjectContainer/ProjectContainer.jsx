...
const ProjectContainer = () => {
  ...
  return (
    <>
      <div style={{ width: '60%', margin: 'auto' , marginTop:'20px',backgroundColor:'red' }} className="d-flex align-items-center justify-content-between">

        <div>
          <div className="d-flex  align-items-center justify-content-around" style={{ gap: '20px' }}>
            <h5 style={{}}>Filter Projects By Status</h5>
            <select style={{ padding: '10px', width: '100px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} value={selectedValue} onChange={handleChange}>
        ...
        <h4 className="headgin">Look into projects</h4>
        <div className="d-flex  align-items-center justify-content-around" style={{ gap: '20px' }}>
        
          <select className="dropdown dropdown-menu dropdown-menu-dark" style={{ padding: '10px', width: '100px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} value={selectedSortValue} onChange={handleSortChange}>
