...
const ProjectContainer = () => {
  ...
  return (
    <>
      <div style={{ width: '60%', margin: 'auto' }} className="d-flex align-items-center justify-content-between">

        <div>
          <div className="d-flex  align-items-center justify-content-around" style={{ gap: '20px' }}>
            <h2 style={{}}>Filter Projects By Status</h2>
        ...
        <h1 className="headgin">Look into projects</h1>
        <div className="d-flex  align-items-center justify-content-around" style={{ gap: '20px' }}>
          <h2 style={{}}>Sort by</h2>
          <select style={{ padding: '10px', width: '100px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} value={selectedSortValue} onChange={handleSortChange}>
